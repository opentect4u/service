<?php
       ...
       if($_SESSION['flag']==true){
        ...
        $sql    = "select distinct trans_dt,trans_no,bill_no,serv_ctr,srv_to
                   from   td_parts_trans where approval_status = 'U' and trans_type = 'T'";
...
<html>
<head>
    <title>Manage Component Transfer</title>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <h2 style="margin-left:60px;text-align:center">Manage Component Transfer</h2>
        <hr class="new">
        <div class="card mb-3">
