<?php
        ...
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            $sql      = "insert into md_service_centre(center_name,address,cnct_no,
                                                       email,in_charge,created_by,created_dt)
                         values('$name','$addr','$phno','$email','$charge','$crtby','$crtdt')";
...
<div style="min-height: 500px;">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <h2 style="margin-left:60px;text-align:center">Add New Service Center</h2>
            <hr class="new">
