<?php
       ...
       if($_SESSION['flag']==true){
        ...
        $sql    = "select distinct trans_dt,bill_no,serv_ctr
                   from   td_parts_stock where approval_status = 'U' and trans_type = 'D'";
...
<html>
<head>
    <title>Manage Damage Components</title>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <h2 style="margin-left:60px;text-align:center">Manage Damage Components</h2>
        <hr class="new">
        <div class="card mb-3">
            <div class="card-header" style="margin-left:60px;">
                <a class="button" href="../stock/addDamage.php"><i class="fa fa-plus"></i>
                    <span>New</span>
                </a>
            </div>
            <hr class="new">
                        ...
                        <table id="dta" class="w3-table-all">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="editDamage.php?bill_no=<?php echo$bill; ?>">
    ...
    $(document).ready(function() {
        ...
        $('.del').click(function(){
            ...
            if(window.confirm('Are you sure you want to delete this record?')){
                ...
                window.location = "http://"+"<?php echo  $_SERVER['HTTP_HOST']; ?>"+"/service/stock/delDamage.php?bill_no="+delCd;
