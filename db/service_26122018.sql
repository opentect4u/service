...
--
-- Host: localhost:3306
-- Generation Time: Dec 26, 2018 at 06:43 PM
...
CREATE TABLE `td_parts_stock` (
  ...
  `srv_ctr` int(5) NOT NULL,
  `parts_no` int(5) NOT NULL,
  `parts_desc` varchar(50) NOT NULL,
  `qty` int(10) NOT NULL,
  `balance` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `td_parts_stock`
  ADD PRIMARY KEY (`trans_dt`,`trans_no`,`parts_no`);
...
--
ALTER TABLE `td_audit_trail`
  MODIFY `sl_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
