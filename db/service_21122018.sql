...
--
-- Host: localhost:3306
-- Generation Time: Dec 21, 2018 at 06:51 PM
...
--
-- Table structure for table `td_mc_service`
--

CREATE TABLE `td_mc_service` (
  `trans_dt` date NOT NULL,
  `trans_cd` int(10) NOT NULL,
  `mc_sl_no` varchar(50) NOT NULL,
  `mc_type_id` int(10) NOT NULL,
  `cust_cd` int(10) NOT NULL,
  `in_dt` date NOT NULL,
  `mc_prob` varchar(50) NOT NULL,
...
--
-- Indexes for table `td_mc_service`
--
ALTER TABLE `td_mc_service`
