...
<div class="form-group row">
	...
	<table id="addAnother" style="margin-left: 120px;">
		<tr>
			...
			<?php
                ...
                while($data1 = mysqli_fetch_array($result1, MYSQLI_NUM)){ $i++;
                  			...
                  			$sql = "select mc_id, mc_type from md_mc_type where mc_id = $data1[7]";

        					$slno  = mysqli_query($db,$sql);
        					
        					$sl_no = mysqli_fetch_assoc($slno);

        					/*$sql1 = "select sl_no_from,sl_no_to from td_device_trans where trans_dt='$trans_dt'and trans_no = $transNo and mc_type=$data1[7]";
