...
<html>
<head>
    <title>Manage Device Sale</title>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <h2 style="margin-left:60px;text-align:center">Manage Device Sale</h2>
        <hr class="new">
        <div class="card mb-3">
    ...
    $(document).ready(function() {
        ...
        $('.del').click(function(){
            ...
            if(window.confirm('Are you sure you want to delete this record?')){
                ...
                var transNo = $(this).attr('id1');

               window.location = "http://"+"<?php echo  $_SERVER['HTTP_HOST']; ?>"+"/service/sale/delSale.php?trans_dt="+transDt+"&trans_no="+transNo;
