        ...
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            for($i = 0; $i < sizeof($comp); $i++){
                 ...
                 $sql          = "insert into td_parts_stock(trans_dt,trans_no,trans_type,bill_no,arrival_dt,
                                  comp_sl_no,comp_qty,serv_ctr,balance,oder_by,remarks,created_by,created_dt)
                                  values('$transDt',$transNo,'D','$billNo','$arvdt',$comp[$i],$compqty[$i],
                                          $serv,0,'$ordby','$rkms','$crtby','$crtdt')";
