<?php
        ...
        $select1 = "select cust_cd,cust_name from md_customers order by cust_name";

        $tech   = mysqli_query($db,$select1);
?>		

<head>
    <title>Customer Wise Device Report</title>
...
<div style="min-height: 500px;">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <h2 style="margin-left:60px;text-align:center">Customer Wise Device Detail</h2>
            <hr class="new">
                        ...
                        <div class="wraper">
                            ...
                            <div class="col-md-6 container form-wraper">
                                ...
                                <form method="POST" id="form"
                                      action="cust_device.php" >

                                    <div class="form-header">
                                        <h4>Supply Dates & Customer</h4>
                                    </div>
