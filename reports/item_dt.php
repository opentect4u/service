<?php
        ...
        $select1 = "select sl_no,center_name from md_service_centre order by center_name";
...
<div style="min-height: 500px;">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <h2 style="margin-left:60px;text-align:center">Item Wise Sale Report</h2>
            <hr class="new">
                        ...
                        <div class="wraper">
                            ...
                            <div class="col-md-6 container form-wraper">
                                ...
                                <form method="POST" id="form"
                                      action="item_sale_rep.php" >

                                    <div class="form-header">
                                        <h4>Supply Dates & Center</h4>
                                    </div>
